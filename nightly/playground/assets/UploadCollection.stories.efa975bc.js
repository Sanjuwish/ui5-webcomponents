import{x as r}from"./lit-element.57026f9a.js";import{l}from"./if-defined.08fba587.js";import{o as v}from"./unsafe-html.5df53a7b.js";import{D as k}from"./docs.7cf63f41.js";import{U as t,L as c}from"./ListItemType.3e96c801.js";import{L as J}from"./ListMode.deaf7bfe.js";import"./index.d901690a.js";import"./_commonjsHelpers.b8add541.js";import"./chunk-PCJTTTQV.5fa0dfb4.js";import"./iframe.01296c4d.js";import"../sb-preview/runtime.mjs";import"./client.6942378e.js";import"./index.3ba038fd.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d2348c08.js";import"./index.b38f6aa4.js";import"./chunk-R4NKYYJA.15989c7a.js";const V={default:{control:{type:"text"}},header:{control:{type:"text"}},drop:{description:"Fired when an element is dropped inside the drag and drop overlay. <br><br> <b>Note:</b> The <code>drop</code> event is fired only when elements are dropped within the drag and drop overlay and ignored for the other parts of the <code>ui5-upload-collection</code>.",table:{category:"events"},UI5CustomData:{parameters:[{name:"dataTransfer",type:"DataTransfer",description:"The <code>drop</code> event operation data."}]}},"item-delete":{description:"Fired when the delete button of any item is pressed.",table:{category:"events"},UI5CustomData:{parameters:[{name:"item",type:"HTMLElement",description:"The <code>ui5-upload-collection-item</code> which was deleted."}]}},"selection-change":{description:"Fired when selection is changed by user interaction in <code>SingleSelect</code> and <code>MultiSelect</code> modes.",table:{category:"events"},UI5CustomData:{parameters:[{name:"selectedItems",type:"Array",description:"An array of the selected items."}]}}},W={package:"@ui5/webcomponents-fiori",since:"1.0.0-rc.7"};var D=Object.freeze,G=Object.defineProperty,s=(e,m)=>D(G(e,"raw",{value:D(m||e.slice())})),$,b,y,T,C;const U="ui5-upload-collection",ve={title:"Fiori/UploadCollection",component:U,subcomponents:{UploadCollectionItem:"ui5-upload-collection-item"},parameters:{docs:{page:k({...W,component:U})}},argTypes:V},a=(e,m,z,A,f,g,h,R,K,q,P)=>`<ui5-upload-collection-item file-name="${e}" upload-state="${z}" ${g?`type="${g}"`:""} ${h?`progress="${h}"`:""} ${m?"file-name-clickable":""} ${R?"disable-delete-button=":""} ${K?"hide-delete-button":""} ${q?"hide-retry-button":""} ${P?"hide-terminate-button":""}>
    ${A}
    ${f||""}
...
}`,...(F=(_=o.parameters)==null?void 0:_.docs)==null?void 0:F.source}}};const De=["WithHeader","RenamingFiles","VariousUploadStates","DragAndDrop"];export{o as DragAndDrop,d as RenamingFiles,n as VariousUploadStates,i as WithHeader,De as __namedExportsOrder,ve as default};
//# sourceMappingURL=UploadCollection.stories.efa975bc.js.map
