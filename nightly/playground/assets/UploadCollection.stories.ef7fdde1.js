import{x as r}from"./lit-element.3a4d34a1.js";import{l}from"./if-defined.d89d00ab.js";import{o as v}from"./unsafe-html.3b27b0e6.js";import{D as k}from"./docs.183dfa35.js";import{U as t,L as c}from"./ListItemType.3e96c801.js";import{L as J}from"./ListMode.deaf7bfe.js";import"./index.bdfa8201.js";import"./_commonjsHelpers.b8add541.js";import"./chunk-PCJTTTQV.ca7a3ba5.js";import"./iframe.44a42e24.js";import"../sb-preview/runtime.js";import"./client.69b06123.js";import"./index.06d16612.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d612502e.js";import"./index.b38f6aa4.js";const V={default:{control:{type:"text"}},header:{control:{type:"text"}},drop:{description:"Fired when an element is dropped inside the drag and drop overlay. <br><br> <b>Note:</b> The <code>drop</code> event is fired only when elements are dropped within the drag and drop overlay and ignored for the other parts of the <code>ui5-upload-collection</code>.",table:{category:"events"},UI5CustomData:{parameters:[{name:"dataTransfer",type:"DataTransfer",description:"The <code>drop</code> event operation data."}]}},"item-delete":{description:"Fired when the delete button of any item is pressed.",table:{category:"events"},UI5CustomData:{parameters:[{name:"item",type:"HTMLElement",description:"The <code>ui5-upload-collection-item</code> which was deleted."}]}},"selection-change":{description:"Fired when selection is changed by user interaction in <code>SingleSelect</code> and <code>MultiSelect</code> modes.",table:{category:"events"},UI5CustomData:{parameters:[{name:"selectedItems",type:"Array",description:"An array of the selected items."}]}}},G={package:"@ui5/webcomponents-fiori",since:"1.0.0-rc.7"};var D=Object.freeze,Q=Object.defineProperty,s=(e,m)=>D(Q(e,"raw",{value:D(m||e.slice())})),$,b,y,T,C;const U="ui5-upload-collection",he={title:"Fiori/Upload Collection",component:U,subcomponents:{UploadCollectionItem:"ui5-upload-collection-item"},parameters:{docs:{page:k({...G,component:U})}},argTypes:V},a=(e,m,z,A,f,g,h,R,K,q,P)=>`<ui5-upload-collection-item file-name="${e}" upload-state="${z}" ${g?`type="${g}"`:""} ${h?`progress="${h}"`:""} ${m?"file-name-clickable":""} ${R?"disable-delete-button=":""} ${K?"hide-delete-button":""} ${q?"hide-retry-button":""} ${P?"hide-terminate-button":""}>
    ${A}
    ${f||""}
...
${a("Notes.txt",!1,t.Complete,"Uploaded By: John Smith \xB7 Uploaded On: 2014-09-02 \xB7 File Size: 226.6 KB",'<ui5-icon name="document-text" slot="thumbnail"></ui5-icon>')}`};i.parameters={docs:{story:{iframeHeight:"500px"}}};i.decorators=[M,j,u];const W=e=>r(y||(y=s(["",`
...
${a("Notes.txt",!1,t.Complete,"Uploaded By: John Smith \xB7 Uploaded On: 2014-09-02 \xB7 File Size: 226.6 KB",'<ui5-icon name="document-text" slot="thumbnail"></ui5-icon>',c.Detail)}`};d.decorators=[W,u];const X=e=>r(T||(T=s(["",`
...
}`,...(L=(S=i.parameters)==null?void 0:S.docs)==null?void 0:L.source}}};var E,B,H;d.parameters={...d.parameters,docs:{...(E=d.parameters)==null?void 0:E.docs,source:{originalSource:`args => {
  return html\`
<ui5-upload-collection
    id="\${ifDefined(args.id)}"
    mode="\${ifDefined(args.mode)}"
...
}`,...(H=(B=d.parameters)==null?void 0:B.docs)==null?void 0:H.source}}};var N,w,I;n.parameters={...n.parameters,docs:{...(N=n.parameters)==null?void 0:N.docs,source:{originalSource:`args => {
  return html\`
<ui5-upload-collection
    id="\${ifDefined(args.id)}"
    mode="\${ifDefined(args.mode)}"
...
}`,...(F=(_=o.parameters)==null?void 0:_.docs)==null?void 0:F.source}}};const ve=["Basic","RenamingFiles","VariousUploadStates","DragAndDrop"];export{i as Basic,o as DragAndDrop,d as RenamingFiles,n as VariousUploadStates,ve as __namedExportsOrder,he as default};
//# sourceMappingURL=UploadCollection.stories.ef7fdde1.js.map
