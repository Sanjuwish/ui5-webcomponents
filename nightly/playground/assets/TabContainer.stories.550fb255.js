import{x as O}from"./lit-element.57026f9a.js";import{l as t}from"./if-defined.08fba587.js";import{o as M}from"./unsafe-html.5df53a7b.js";import{D as S}from"./docs.68d49acc.js";import{T as P}from"./TabLayout.94ac13df.js";import"./index.bdfa8201.js";import"./_commonjsHelpers.b8add541.js";import"./chunk-PCJTTTQV.9d49501c.js";import"./iframe.169c7c73.js";import"../sb-preview/runtime.js";import"./client.69b06123.js";import"./index.5857a530.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d612502e.js";import"./index.b38f6aa4.js";const q={allItems:{control:{type:!1}},contentBackgroundDesign:{control:"select",options:["Solid","Translucent","Transparent"]},headerBackgroundDesign:{control:"select",options:["Solid","Translucent","Transparent"]},tabLayout:{control:"select",options:["Inline","Standard"]},tabsOverflowMode:{control:"select",options:["End","StartAndEnd"]},default:{control:{type:"text"}},overflowButton:{control:{type:"text"}},startOverflowButton:{control:{type:"text"}},"tab-select":{description:"Fired when a tab is selected.",table:{category:"events"},UI5CustomData:{parameters:[{name:"tab",type:"HTMLElement",description:"The selected <code>tab</code>."},{name:"tabIndex",type:"Integer",description:"The selected <code>tab</code> index in the flattened array of all tabs and their subTabs, provided by the <code>allItems</code> getter."}]}}},I={package:"@ui5/webcomponents"},b="ui5-tabcontainer",V={title:"Main/TabContainer",component:b,subcomponents:{Tab:"ui5-tab",TabSeparator:"ui5-tab-separator"},parameters:{docs:{page:S({...I,component:b})}},argTypes:q},a=e=>O`<ui5-tabcontainer
    ?fixed="${t(e.fixed)}"
...
}`,...(B=(L=u.parameters)==null?void 0:L.docs)==null?void 0:B.source}}};const X=["Basic","TextOnlyTabs","TextOnlyEndOverflow","WithAdditionalText","InlineTabLayout","NestedTabs"];export{i as Basic,r as InlineTabLayout,u as NestedTabs,o as TextOnlyEndOverflow,n as TextOnlyTabs,s as WithAdditionalText,X as __namedExportsOrder,V as default};
//# sourceMappingURL=TabContainer.stories.550fb255.js.map
