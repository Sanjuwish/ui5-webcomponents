...
>
    ${f||""}
    ${p==null?void 0:p.map(W=>`<ui5-button design="Transparent" slot="action">${W}</ui5-button>`)}
...
</ui5-table>`};a.decorators=[m("40rem")];a.parameters={docs:{page:b({...g,component:d}),story:{iframeHeight:"250px",inline:!1}}};const r=o.bind({});r.args={header:i("Upcoming Activities","Today"),default:`<ui5-timeline>
...
</ui5-timeline>`};r.decorators=[m("22rem")];const s=o.bind({}),E=[{header:i("David Williams","Sales Manager"),default:`<ui5-list separators="Inner">
    ...
    <div class="content-group">
        ...
        <ui5-link target="_blank">www.company_a.example.com</ui5-link>
            ...
            <div class="grid-container">
                ${E.map(n=>e({args:{...n}}))}
            </div>`];s.parameters={docs:{page:b({...g,component:d}),story:{iframeHeight:"680px",inline:!1}}};var $,y,S;t.parameters={...t.parameters,docs:{...($=t.parameters)==null?void 0:$.docs,source:{originalSource:`args => {
  return html\`
<ui5-card
...
>
    ...
    \`;
}`,...(D=(T=l.parameters)==null?void 0:T.docs)==null?void 0:D.source}}};var w,M,H;a.parameters={...a.parameters,docs:{...(w=a.parameters)==null?void 0:w.docs,source:{originalSource:`args => {
  return html\`
<ui5-card
    accessible-name="\${ifDefined(args.accessibleName)}"
    accessible-name-ref="\${ifDefined(args.accessibleNameRef)}"
>
    ...
    \`;
}`,...(H=(M=a.parameters)==null?void 0:M.docs)==null?void 0:H.source}}};var _,N,R;r.parameters={...r.parameters,docs:{...(_=r.parameters)==null?void 0:_.docs,source:{originalSource:`args => {
  return html\`
<ui5-card
    accessible-name="\${ifDefined(args.accessibleName)}"
    accessible-name-ref="\${ifDefined(args.accessibleNameRef)}"
>
    ...
    \`;
}`,...(R=(N=r.parameters)==null?void 0:N.docs)==null?void 0:R.source}}};var k,A,C;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`args => {
  return html\`
<ui5-card
    accessible-name="\${ifDefined(args.accessibleName)}"
    accessible-name-ref="\${ifDefined(args.accessibleNameRef)}"
>
    ...
    \`;
}`,...(C=(A=s.parameters)==null?void 0:A.docs)==null?void 0:C.source}}};const ee=["InteractiveHeader","WithList","WithTable","WithTimeline","More"];export{t as InteractiveHeader,s as More,l as WithList,a as WithTable,r as WithTimeline,ee as __namedExportsOrder,Z as default};
//# sourceMappingURL=Card.stories.d321394e.js.map
