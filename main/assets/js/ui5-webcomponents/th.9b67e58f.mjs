const M = "This file has been derived from Unicode Common Locale Data Repository (CLDR) files (http://cldr.unicode.org). See the copyright and permission notice in the Unicode-Data-Files-LICENSE.txt available at the same location as this file or visit http://www.unicode.org/copyright.html", e = "41.0.0", t = "2022-12-19T09:41:25.319Z", a = "left-to-right", r = {
  era: {
    displayName: "\u0E2A\u0E21\u0E31\u0E22"
  },
  "year-wide": {
  ...
  dayPeriodRules: u,
  calendarPreference: s
};
export {
  t as __buildtime,
  M as __license,
  e as __version,
  s as calendarPreference,
  E as currencyDigits,
  n as currencyFormat,
