...
so that we can use `,e.exports.jsx(s.code,{children:"browser.debug()"})," in our ",e.exports.jsx(s.code,{children:"*.spec.js"})," files. For more on testing, see ",e.exports.jsx(s.a,{href:"./05-testing-ui5-web-components.md",children:"Testing Web Components"}),"."]}),`
`]}),`
`]}),`
...
`,e.exports.jsx(s.a,{href:"./02-custom-ui5-web-components.md",children:"Developing Web Components"})," section of the documentation."]}),`
...
`,e.exports.jsxs(s.p,{children:["For more on testing, see our ",e.exports.jsx(s.a,{href:"./05-testing-ui5-web-components.md",children:"Testing Web Components"})," section."]}),`
...
`})}),`
`,e.exports.jsxs(s.p,{children:["Next: ",e.exports.jsx(s.a,{href:"./02-custom-UI5-Web-Components.md",children:"Developing Custom UI5 Web Components"})]})]})}}export{b as default};
//# sourceMappingURL=01-custom-UI5-Web-Components-Packages.5241f0d0.js.map
