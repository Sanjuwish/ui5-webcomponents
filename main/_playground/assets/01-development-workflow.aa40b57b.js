...
`,e.exports.jsxs(s.ul,{children:[`
`,e.exports.jsxs(s.li,{children:[e.exports.jsx(s.a,{href:"./?path=/docs/docs-contributing-conventions-and-guidelines--docs",children:"Development Conventions and Guidelines"}),";"]}),`
`,e.exports.jsxs(s.li,{children:[e.exports.jsx(s.a,{href:"./?path=/docs/docs-development-custom-ui5-web-components--docs",children:"Developing Custom UI5 Web Components"}),";"]}),`
`,e.exports.jsxs(s.li,{children:[e.exports.jsx(s.a,{href:"./?path=/docs/docs-development-testing-ui5-web-components--docs",children:"Testing UI5 Web Components"}),";"]}),`
`,e.exports.jsxs(s.li,{children:[e.exports.jsx(s.a,{href:"./?path=/docs/docs-development-understanding-components-metadata--docs",children:"Understanding UI5 Web Components Metadata"}),"."]}),`
`]}),`
...
`})}),`
`,e.exports.jsxs(s.p,{children:[e.exports.jsx(s.strong,{children:"Note:"})," The full guide on how to sync a fork can be found ",e.exports.jsx(s.a,{href:"https://docs.github.com/en/github/collaborating-with-issues-and-pull-requests/syncing-a-fork",children:"here"}),"."]})]})}}export{f as default};
//# sourceMappingURL=01-development-workflow.aa40b57b.js.map
