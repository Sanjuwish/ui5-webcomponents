...
For more information on creating a new package with a demo Web Component inside, click `,e.exports.jsx(t.a,{href:"./01-custom-ui5-web-components-packages.md",children:"here"}),"."]}),`
...
`,e.exports.jsxs(t.p,{children:["For a complete reference to all metadata entities, click ",e.exports.jsx(t.a,{href:"./03-understanding-components-metadata.md",children:"here"}),"."]}),`
...
`,e.exports.jsxs(t.p,{children:["Furthermore, in order to make use of the ",e.exports.jsx(t.a,{href:"../2-advanced/03-scoping.md",children:"Scoping"})," feature, you must list all the internally used web components in the ",e.exports.jsx(t.code,{children:"dependencies"}),` static getter,
...
`,e.exports.jsxs(t.li,{children:["Get texts from the bundle, according to the currently ",e.exports.jsx(t.a,{href:"../2-advanced/01-configuration.md",children:"configured"}),` language
...
`,e.exports.jsxs(t.p,{children:["Next: ",e.exports.jsx(t.a,{href:"./03-understanding-components-metadata.md",children:"Understanding UI5 Web Components Metadata"})]})]})}}export{g as default};
//# sourceMappingURL=02-custom-UI5-Web-Components.173e59b7.js.map
