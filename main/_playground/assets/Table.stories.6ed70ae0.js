import{x as e}from"./lit-element.57026f9a.js";import{D as z}from"./docs.318f61f1.js";import"./index.d901690a.js";import"./_commonjsHelpers.b8add541.js";import"./chunk-PCJTTTQV.adba910b.js";import"./iframe.035bd2e1.js";import"../sb-preview/runtime.mjs";import"./client.6942378e.js";import"./index.c1e7c048.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d2348c08.js";import"./index.b38f6aa4.js";import"./chunk-R4NKYYJA.15989c7a.js";const V={growing:{control:"select",options:["Button","None","Scroll"]},mode:{control:"select",options:["MultiSelect","None","SingleSelect"]},columns:{control:{type:"text"}},default:{control:{type:"text"}},"popin-change":{description:"Fired when <code>ui5-table-column</code> is shown as a pop-in instead of hiding it.",table:{category:"events"},UI5CustomData:{parameters:[{name:"poppedColumns",type:"Array",description:"popped-in columns."}]}},"row-click":{description:"Fired when a row in <code>Active</code> mode is clicked or <code>Enter</code> key is pressed.",table:{category:"events"},UI5CustomData:{parameters:[{name:"row",type:"HTMLElement",description:"the activated row."}]}},"selection-change":{description:"Fired when selection is changed by user interaction in <code>SingleSelect</code> and <code>MultiSelect</code> modes.",table:{category:"events"},UI5CustomData:{parameters:[{name:"selectedRows",type:"Array",description:"An array of the selected rows."},{name:"previouslySelectedRows",type:"Array",description:"An array of the previously selected rows."}]}}},q={package:"@ui5/webcomponents"};var p=Object.freeze,F=Object.defineProperty,Q=(c,L)=>p(F(c,"raw",{value:p(L||c.slice())})),m,d;const g="ui5-table",se={title:"Main/Table",component:g,subcomponents:{TableColumn:"ui5-table-column",TableRow:"ui5-table-row",TableGroupRow:"ui5-table-group-row",TableCell:"ui5-table-cell"},parameters:{docs:{page:z({...q,component:g})}},argTypes:V},a=()=>e`
<h3>Basic Table</h3>
...
\``,...(K=(j=u.parameters)==null?void 0:j.docs)==null?void 0:K.source}}};const ue=["Template0","Template1","Template2","Template3","Template4","Template5","Template6","Template7","Template8"];export{a as Template0,o as Template1,r as Template2,n as Template3,l as Template4,t as Template5,i as Template6,s as Template7,u as Template8,ue as __namedExportsOrder,se as default};
//# sourceMappingURL=Table.stories.6ed70ae0.js.map
