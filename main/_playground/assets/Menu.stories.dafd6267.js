import{x as m}from"./lit-element.57026f9a.js";import{o as O}from"./unsafe-html.5df53a7b.js";import{l as o}from"./if-defined.08fba587.js";import{D}from"./docs.01bffc07.js";import"./index.d901690a.js";import"./_commonjsHelpers.b8add541.js";import"./chunk-PCJTTTQV.dc04cfa9.js";import"./iframe.03a57387.js";import"../sb-preview/runtime.mjs";import"./client.6942378e.js";import"./index.00a06e2e.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d2348c08.js";import"./index.b38f6aa4.js";import"./chunk-R4NKYYJA.15989c7a.js";const $={default:{control:{type:"text"}},close:{description:"Closes the Menu.",table:{category:"methods"}},showAt:{description:"Shows the Menu near the opener element.",table:{category:"methods"},UI5CustomData:{parameters:[{name:"opener",type:"HTMLElement",optional:!1,description:"the element that the popover is shown at"}]}},"before-close":{description:"Fired before the menu is closed. This event can be cancelled, which will prevent the menu from closing. <b>This event does not bubble.</b>",table:{category:"events"},UI5CustomData:{parameters:[{name:"escPressed",type:"boolean",description:"Indicates that <code>ESC</code> key has triggered the event."}]}},"before-open":{description:"Fired before the menu is opened. This event can be cancelled, which will prevent the menu from opening. <b>This event does not bubble.</b>",table:{category:"events"},UI5CustomData:{parameters:[{name:"item",type:"object",description:"The <code>ui5-menu-item</code> that triggers opening of the sub-menu. Note: available since 1.14.0."}]}},"item-click":{description:"Fired when an item is being clicked.",table:{category:"events"},UI5CustomData:{parameters:[{name:"item",type:"object",description:"The currently clicked menu item."},{name:"text",type:"string",description:"The text of the currently clicked menu item."}]}}},M={package:"@ui5/webcomponents",since:"1.3.0"};var a=Object.freeze,C=Object.defineProperty,r=(e,w)=>a(C(e,"raw",{value:a(w||e.slice())})),s,c,d;const p="ui5-menu",q={title:"Main/Menu",component:p,subcomponents:{MenuItem:"ui5-menu-item"},parameters:{docs:{page:D({...M,component:p})}},argTypes:$},u=e=>m`<ui5-menu
...
<ui5-menu-item text="Close"></ui5-menu-item>
<ui5-menu-item text="Preferences" icon="action-settings" starts-section=""></ui5-menu-item>
<ui5-menu-item text="Exit" icon="journey-arrive"></ui5-menu-item>`};n.decorators=[e=>m(c||(c=r([`<ui5-button id="btnOpenBasic" class="samples-margin">Open Menu</ui5-button> <br/>
    `,`
    <script>
        btnOpenBasic.addEventListener("click", function(event) {
...
<ui5-menu-item text="Close"></ui5-menu-item>
<ui5-menu-item text="Preferences" icon="action-settings" starts-section=""></ui5-menu-item>
<ui5-menu-item text="Exit" icon="journey-arrive" additional-text="Ctrl+X"></ui5-menu-item>`};i.decorators=[e=>m(d||(d=r([`<ui5-button id="btnOpenAdditionalText" class="samples-margin">Open Menu</ui5-button> <br/>
    `,`
    <script>
...
//# sourceMappingURL=Menu.stories.dafd6267.js.map
