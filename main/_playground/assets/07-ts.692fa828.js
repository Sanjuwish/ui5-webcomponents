...
`})}),`
`,e.exports.jsx(t.h3,{children:"Defining the tag, static getters and other settings"}),`
`,e.exports.jsxs(t.p,{children:["Use ",e.exports.jsx(t.code,{children:"@customElement"})," as a replacement for the metadata ",e.exports.jsx(t.code,{children:"tag"})," setting and all the ",e.exports.jsx(t.code,{children:"static get"})," methods."]}),`
`,e.exports.jsxs(t.p,{children:["Use ",e.exports.jsx(t.code,{children:"themeAware"}),", ",e.exports.jsx(t.code,{children:"languageAware"})," and ",e.exports.jsx(t.code,{children:"fastNavigation"})," where needed."]}),`
...
`})}),`
`,e.exports.jsxs(t.p,{children:["And the pattern goes on for all the ",e.exports.jsx(t.code,{children:"static get"})," methods as well, such as :"]}),`
`,e.exports.jsxs(t.ul,{children:[`
`,e.exports.jsxs(t.li,{children:[e.exports.jsx(t.code,{children:"static get render()"}),";",`
`,e.exports.jsxs(t.ul,{children:[`
`,e.exports.jsxs(t.li,{children:[e.exports.jsx(t.strong,{children:"Note!"}),": We now use it as ",e.exports.jsx(t.strong,{children:e.exports.jsx(t.code,{children:"renderer"})})," instead of ",e.exports.jsx(t.code,{children:"render"})," in the ",e.exports.jsx(t.code,{children:"@customElement"})," decorator as we can see from the example;"]}),`
`]}),`
`]}),`
`,e.exports.jsxs(t.li,{children:[e.exports.jsx(t.code,{children:"static get dependencies()"}),";"]}),`
`,e.exports.jsxs(t.li,{children:[e.exports.jsx(t.code,{children:"static get staticAreaStyles()"}),";"]}),`
`,e.exports.jsxs(t.li,{children:[e.exports.jsx(t.code,{children:"static get staticAreaTemplate()"}),";"]}),`
`]}),`
`,e.exports.jsx("br",{}),`
...
`})})]})}}export{g as default};
//# sourceMappingURL=07-ts.692fa828.js.map
