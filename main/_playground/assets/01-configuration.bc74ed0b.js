...
`})}),`
`,e.exports.jsxs(s.p,{children:["For more about assets, see the dedicated ",e.exports.jsx(s.a,{href:"../1-getting-started/05-using-assets.md",children:"Assets"})," section."]}),`
`,e.exports.jsxs(s.ul,{children:[`
...
`,e.exports.jsxs(s.p,{children:["Calendar types are opt-in features, see ",e.exports.jsx(s.a,{href:"../1-getting-started/06-using-features.md",children:"Using Features"}),` for details.
...
`})}),`
`,e.exports.jsxs(s.p,{children:["Next: ",e.exports.jsx(s.a,{href:"./02-rtl-and-compact-mode.md",children:"Right-To-Left (RTL) And Compact Mode"})]})]})}}export{f as default};
//# sourceMappingURL=01-configuration.bc74ed0b.js.map
